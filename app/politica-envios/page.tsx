...
export const metadata: Metadata = {
  title: "Política de Envíos — Beekonz",
  description: "Información sobre envíos nacionales e internacionales, tiempos de entrega y seguimiento.",
};
    ...
    <>
      ...
      <div className="pt-32 pb-24 px-6">
        <div className="container mx-auto max-w-3xl">
          <h1 className="text-3xl md:text-5xl font-display font-bold mb-8">Política de Envíos</h1>
