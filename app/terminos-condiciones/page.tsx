...
export const metadata: Metadata = {
  title: "Términos y Condiciones — Beekonz",
  description: "Términos y condiciones de uso del sitio web y productos Beekonz.",
};
    ...
    <>
      ...
      <div className="pt-32 pb-24 px-6">
        <div className="container mx-auto max-w-3xl">
          <h1 className="text-3xl md:text-5xl font-display font-bold mb-8">Términos y Condiciones</h1>
